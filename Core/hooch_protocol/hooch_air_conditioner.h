...
typedef enum
{
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_INVALID = 0U,       /* 无效控制项 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_ALL,                /* 全量控制 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_POWER,              /* 仅控制开关 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_MODE,               /* 仅控制模式 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_FAN_SPEED,          /* 仅控制风速 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_TEMPERATURE,        /* 仅控制温度 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_CURRENT_TEMPERATURE,/* 当前温度（实际室温） */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_ENABLE,             /* 空调使能 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_DEVICE_DESC,        /* 设备描述字符串 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_DEFAULT_ICON,       /* 默认图标 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_SELECTED_ICON,      /* 选中图标 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_TEMP_STEP,          /* 温度设置步进 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_TEMP_MIN,           /* 最小设置温度 (预留)*/
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_TEMP_MAX,           /* 最大设置温度(预留) */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_ALL_TUYA,           /* 全量控制涂鸦 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_ALL_XIAOMI,         /* 全量控制小米 */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_ALL_KNX,            /* 全量控制KNX */
    HOOCH_PROTOCOL_AIR_CONDITIONER_CONTROL_ITEM_MAX,                /* 哨兵值，新增枚举请插入到上方 */
