...
#include <string.h>
/* 支持的按键数量。 */
#define HOOCH_PROTOCOL_KEY_MODE_KEY_COUNT    16U
...
typedef enum
{
    ...
    HOOCH_PROTOCOL_KEY_MODE_KEY_9,
    HOOCH_PROTOCOL_KEY_MODE_KEY_10,
    HOOCH_PROTOCOL_KEY_MODE_KEY_11,
    HOOCH_PROTOCOL_KEY_MODE_KEY_12,
    HOOCH_PROTOCOL_KEY_MODE_KEY_13,
    HOOCH_PROTOCOL_KEY_MODE_KEY_14,
    HOOCH_PROTOCOL_KEY_MODE_KEY_15,
    HOOCH_PROTOCOL_KEY_MODE_KEY_16,
...
typedef enum
{
    ...
    HOOCH_PROTOCOL_KEY_MODE_TYPE_ALWAYS_ON_SWITCH = 13U,        /* 常开模式：怎么点都是开 */
    HOOCH_PROTOCOL_KEY_MODE_TYPE_ALWAYS_OFF_SWITCH = 14U,       /* 常闭模式：怎么点都是关 */
