...
typedef enum
{
    ...
    HOOCH_PROTOCOL_CURTAIN_KEY_9,
    HOOCH_PROTOCOL_CURTAIN_KEY_10,
    HOOCH_PROTOCOL_CURTAIN_KEY_11,
    HOOCH_PROTOCOL_CURTAIN_KEY_12,
    HOOCH_PROTOCOL_CURTAIN_KEY_13,
    HOOCH_PROTOCOL_CURTAIN_KEY_14,
    HOOCH_PROTOCOL_CURTAIN_KEY_15,
    HOOCH_PROTOCOL_CURTAIN_KEY_16,
...
typedef enum
{
    ...
    HOOCH_PROTOCOL_CURTAIN_CONTROL_ITEM_ENABLE_BIT,   /* 仅更新使能位(1 byte 位图, bit0:使能 bit1:开关 bit2:停止 bit3:百分比 bit4:角度) */
