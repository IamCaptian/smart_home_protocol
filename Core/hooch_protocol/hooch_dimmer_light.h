...
typedef enum
{
    ...
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_9,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_10,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_11,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_12,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_13,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_14,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_15,
    HOOCH_PROTOCOL_DIMMER_LIGHT_KEY_16,
...
typedef enum
{
    ...
    HOOCH_PROTOCOL_DIMMER_LIGHT_CONTROL_ITEM_PERCENT,         /* 仅更新色温百分比(0-100) */
    ...
    HOOCH_PROTOCOL_DIMMER_LIGHT_CONTROL_ITEM_COLOR_TEMP_RAW,    /* 仅更新色温原始值(2 byte, 0-65535, 不归一化到0-100) */
    HOOCH_PROTOCOL_DIMMER_LIGHT_CONTROL_ITEM_SWITCH_MODE,        /* 仅更新开关模式(1 byte: 0:常关 1:常开 2:翻转) */
...
/* 上报调光灯色温原始值 0-65535（类型1：仅通道+数值，不归一化到0-100） */
