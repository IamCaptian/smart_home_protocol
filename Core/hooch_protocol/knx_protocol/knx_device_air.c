    ...
    switch (frame->fun[4])
    {
        ...
        case 7U:
            ...
            if (frame->data_len >= 2U)
            {
                ...
                air_conditioner_frame.temperature = (uint8_t)(knx_read_be_u16(frame->data) / 10U);
                air_conditioner_frame.control_item =
        ...
        case 9U:
            ...
            {
                /* 温度值为 0~500，实际温度 = value * 0.1℃ */
                air_conditioner_frame.current_temperature = (uint8_t)(knx_read_be_u16(frame->data) / 10U);
                air_conditioner_frame.control_item =
